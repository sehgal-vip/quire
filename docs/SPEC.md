...
interface PDFTool {
  ...
  pipelineCompatible: boolean;     // false for Merge (needs multiple file inputs)
...
- Category colors: Organize blue-500, Transform amber-500, Stamp purple-500, Security red-500, Info green-500
...
- `filename-generator.ts` — all 13 tool name patterns, sanitization, length limits
...
- `with-forms.pdf` — contains form fields
